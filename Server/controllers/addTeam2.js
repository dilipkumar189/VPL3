const Team = require('../models/addTeam2');
const cloudinary = require('../utils/cloudinary');
const fs = require('fs');

exports.createTeam2 = async (req, res) => {
  try {
    const { team_name, village, sponser_1, sponser_2, captain, mobile, player1, player2 } = req.body;

    // Check if all required field are present
    if (!team_name || !village || !sponser_1 || !sponser_2 || !captain || !mobile || !player1 || !player2 ) {
